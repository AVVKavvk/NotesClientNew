        ...
        <div className=" w-[69%] ml-[3%] gap-5">
          <div class="flex from-white justify-center text-grayText font-mullish items-center mx-auto p-2 text-justify gap-4 mt-4 ">
            <p>
              ...
              and study materials, meticulously curated to cover every aspect of
              your courses. Whether you're revising for an exam, working on an
          ...
          <div class="flex from-white justify-center text-grayText font-mullish items-center mx-auto p-2 text-justify gap-4 mt-4 ">
            ...
            <p>
              ...
              and practical exercises to reinforce your understanding of complex
              concepts.
            </p>
          </div>
          <div class="flex from-white justify-center text-grayText font-mullish items-center mx-auto p-2 text-justify gap-4 mt-4 ">
          ...
          <div class="flex from-white justify-center text-grayText font-mullish items-center mx-auto p-2 text-justify gap-4 mt-4 ">
            <p>
              A student's CGPA significantly influences their career prospects.
              A high CGPA opens doors to prestigious job placements, with many
              employers equating it to dedication and consistency. It showcases
              a strong work ethic and the ability to meet deadlines, qualities
              highly sought after in the professional world. It also acts as a
              key factor for postgraduate admissions in renowned institutions.
              In essence, CGPA isn't just a metric; it's a critical factor in
