            ...
            <div class="z-[100] absolute w-full h-full flex flex-col text-justify justify-between pl-5 py-6 pr-8">
              <div>
                ...
                <p class="font-mullish text-grayText mt-6">
                  ...
                  enjoy playing with computer codes for making websites. It's a
                  friendly place where you can try out your own creative ideas
                  in HTML, CSS, and JavaScript.It's a great spot for both
                  beginners and experienced coders to learn, share, and work
                  together.
                </p>
                <img
                  src={wave}
          ...
          <div class="w-full  relative cursor-pointer  min-h-[16.2rem] group rounded-md">
            ...
            <div class="z-[100] absolute w-full h-full flex flex-col text-justify justify-between pl-5 py-6 pr-8">
              <div>
                ...
                <p class="font-mullish text-grayText mt-6">
                  Welcome to the DSA and C++ Algorithms Bot! This special bot is
                  your gateway to DSA knowledge and essential C++ code for key
                  problems. To begin your journey, all you need to do is type a
                  command that starts with '/'. We've made it super easy for
                  you. You can also simply click on any of the commands
                  provided.This way, you can quickly access a world of
