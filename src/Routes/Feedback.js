...
function Feedback() {
  ...
  return (
    <div
      ...
      className="max-w-[500px]   min-w-[310px] text-white mx-auto rounded-md  md:text-lg  flex flex-col max-h-[500px] mb-6 py-3 min-h-[700px] gap-4 border justify-center  items-center text-justify m-6 px-4 "
    >
      <p >
