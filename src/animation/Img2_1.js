          ...
          <g mask="url(#mask0)">
            <g id="composition">
              ...
              <g id="balcony_01">
                <path
                  id="Rectangle 427"
                  d="M20 21H26V27H20V21Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 427 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <g id="balcony_04">
                <path
                  id="Rectangle 433"
                  d="M20 34H26V40H20V34Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 433 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <g id="balcony_02">
                <path
                  id="Rectangle 429"
                  d="M31 21H37V27H31V21Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 429 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <g id="balcony_05">
                <path
                  id="Rectangle 440"
                  d="M31 34H37V40H31V34Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 440 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <g id="balcony_03">
                <path
                  id="Rectangle 431"
                  d="M42 21H48V27H42V21Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 431 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <g id="balcony_06">
                <path
                  id="Rectangle 435"
                  d="M42 34H48V40H42V34Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 435 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
              ...
              <g id="door">
                <path
                  id="Rectangle 434"
                  d="M28 55H34V65H28V55Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 434 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                ...
                <path
                  id="Rectangle 439"
                  d="M34 55H40V65H34V55Z"
                  fill="#F1FAEE"
                />
                <path
                  id="Rectangle 439 (Stroke)"
                  fill-rule="evenodd"
                  clip-rule="evenodd"
