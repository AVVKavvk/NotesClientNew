  ...
  return (
...

    {
      ...
      <div className="md:w-1/3 flex flex-col items-center p-6 rounded-lg  shadow-xl">
       <a href= {user?.image || "https://res.cloudinary.com/dufi9bxnq/image/upload/v1731948868/VipinNotes%20Users/dummy.png" }   target="_blank" rel="noopener noreferrer">
        <img
            src={user?.image || "https://res.cloudinary.com/dufi9bxnq/image/upload/v1731948868/VipinNotes%20Users/dummy.png" }
            alt="Profile"
      ...
      {/* Bottom Section - Lazy Loaded Routes */}
      <div className="mt-6 w-full">
        <Suspense fallback={<div className="text-center">Loading...</div>}>
          <Routes>
            <Route path="update/image" element={<ImageUpload />} />
            <Route path="update/basic" element={<BasicDetails />} />
          </Routes>
        </Suspense>
      </div>
    </div>}
