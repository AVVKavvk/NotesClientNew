          ...
          return (
            <div>
              <a
                href={item.pdfUrl}
                target="_blank"
                className=" flex-col hover:scale-110 transition-all duration-500 text-2xl bg-red-500 m-3 rounded-md w-[120px] h-[120px] flex justify-center items-center mx-auto "
              >
                <h1>{subjectName}</h1>
              </a>
