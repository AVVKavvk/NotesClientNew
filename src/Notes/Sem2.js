...
function Sem2() {
  ...
  return (
    <div class="mx-auto min-h-screen lg:w-[1200px] mt-7 text-white ">
      ...
      <div class=" lg:w-[1200px] grid sm:grid-cols-3 grid-cols-2  ml-6 lg:mx-auto  gap-4 lg:grid-cols-7 relative  justify-evenly  mt-8 overflow-hidden">
        {data?.map(item => {
          ...
          return (
            <div>
              <a
                href={item.pdfUrl}
                target="_blank"
                className=" flex-col hover:scale-110 transition-all duration-500 text-2xl bg-blue-500 m-3 rounded-md w-[120px] h-[120px] flex justify-center items-center mx-auto "
              >
                <h1>{subjectName}</h1>
              </a>
