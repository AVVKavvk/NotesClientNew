          ...
          return (
            <div>
              <a
                href={item.pdfUrl}
                target="_blank"
                className=" flex-col text-2xl hover:scale-110 transition-all duration-500 bg-green-500 m-3 rounded-md w-[120px] h-[120px] flex justify-center items-center mx-auto "
              >
                <h1>{subjectName}</h1>
              </a>
