    ...
    <div class="lg:w-[1200px]  mx-auto  ">
      ...
      <div class="mx-auto flex flex-col justify-center items-center mt-5 mb-10 ">
        <h1 class=" max-w-[500px] p-2 text-xl  sm:text-2xl text-center mb-8">
          {" "}
          <span class="text-2xl sm:text-3xl mx-3"> Acknowledgement</span> for
          Notes
        </h1>
        <div class="max-w-[1000px] flex-col  sm:space-y-0 flex mx-auto justify-center gap-6 items-center ">
          ...
          <div class="flex flex-col w-[120px] space-y-3  ">
            <div class="flex justify-between items-center">
              <a
                target="_blank"
                href="https://www.linkedin.com/in/sourish-mittal-688523226"
              ...
              <a
                target="_blank"
                href="https://github.com/SourishMittal"
                class="hover:scale-125 transition-all duration-500 "
              >
                {" "}
                <FaGithubSquare />
              ...
              <a
                target="_blank"
                href="https://www.instagram.com/iamsourishmittal/"
                class="hover:scale-125 transition-all duration-500 "
              >
                {" "}
                <FaInstagramSquare />
              ...
              <a
                target="_blank"
                href="https://twitter.com/imsourishmittal"
                class="hover:scale-125 transition-all duration-500 "
              >
                {" "}
                <AiOutlineTwitter />
            ...
            <div class="flex justify-between items-center">
              <a
                target="_blank"
                href="https://www.snapchat.com/add/sourish.mittal?share_id=iNB27WvlkxM&locale=en-US"
                class="hover:scale-125 transition-all duration-500 "
              >
                {" "}
                <FaSnapchatGhost />
              ...
              <a
                target="_blank"
                href="https://www.codechef.com/users/sourish_mittal"
                class="hover:scale-125 transition-all duration-500 "
              >
                {" "}
                <SiCodechef />
              ...
              <a
                target="_blank"
                href="https://codeforces.com/profile/sourish_mittal"
                class="hover:scale-125 transition-all duration-500 "
              >
                {" "}
                <SiCodeforces />
              ...
              <a
                target="_blank"
                href="https://leetcode.com/sourish_mittal/"
                class="hover:scale-125  transition-all duration-500 "
              >
                {" "}
                <SiLeetcode />
